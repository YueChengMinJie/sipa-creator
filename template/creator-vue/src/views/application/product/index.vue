...
import { applicationAll, productList, productDelete } from '@/api/sso-idp-server'
...
export default {
  ...
  methods: {
    ...
    handleDetail(id) {
      this.$router.push({ name: 'applicationProductDetail', query: { appId: this.appList[this.activeName].id, id } })
    }
  }
}
</script>
