package com.sipa.tcp.creator.ut;
...
public class SqlParserTest {
    ...
    public void testConditionParse() {
        DataSourceConfig dsc =
            new DataSourceConfig.Builder("jdbc:mysql://localhost:3306/sipa-creator", "root", "zhou7890-=").build();
        ...
        conditions.forEach((condition) -> {
            ...
            Assertions
                .assertThat(ReUtil.contains(Pattern.compile(condition.getFindPattern(), Pattern.CASE_INSENSITIVE), sql))
                .isTrue();
        });
