<template>
  <el-form ref="editForm" :model="form" label-width="200px" size="mini">
    ...
    <el-form-item label="是否生成swagger3注解" placeholder>
      <el-switch v-model="form.swagger3"></el-switch>
    </el-form-item>
    <el-form-item>
      <el-button disabled type="primary" @click="onSubmit">保存</el-button>
    </el-form-item>
  </el-form>
</template>
<script>
